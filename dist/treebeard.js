...
;(function (global, factory) {
    ...
    Item.prototype.prev = function _itemPrev() {
     ...
     // TODO: for all item methods; throw errors in nothing, return from loop as early as possible
    Item.prototype.child = function _itemChild(childID) {
        ...
        if (!child) {
            throw new Error("Item.child(): No child found.");
        }
    };
    ...
    Item.prototype.sort_children = function _item_sort(direction, field) {
        if (direction === "asc") {
